...
export const upsertOnehyper_cgm_dataMutationObject = defineMutationFunction((t) =>
  defineMutationPrismaObject({
    type: 'hyper_cgm_data',
    nullable: false,
    args: upsertOnehyper_cgm_dataMutationArgs,
    resolve: async (query, _root, args, _context, _info) =>
      await db.hyper_cgm_data.upsert({
        where: args.where,
        create: args.create,
        update: args.update,
        ...query,
...
export const upsertOnehyper_cgm_dataMutation = defineMutation((t) => ({
  upsertOnehyper_cgm_data: t.prismaField(upsertOnehyper_cgm_dataMutationObject(t)),
}));
