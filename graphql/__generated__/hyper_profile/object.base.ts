...
export const hyper_profileObject = definePrismaObject('hyper_profile', {
  ...
  fields: (t) => ({
    ...
    hyper_activity: t.relation('hyper_activity', hyper_profileHyper_activityFieldObject(t)),
    hyper_cgm_data: t.relation('hyper_cgm_data', hyper_profileHyper_cgm_dataFieldObject(t)),
    hyper_daily_recap: t.relation('hyper_daily_recap', hyper_profileHyper_daily_recapFieldObject(t)),
    ...
    hyper_report: t.relation('hyper_report', hyper_profileHyper_reportFieldObject(t)),
  }),
});
...
export const hyper_profileImageFieldObject = defineFieldObject('hyper_profile', {
  type: "String",
  description: undefined,
  nullable: true,
...
export const hyper_profileEmailFieldObject = defineFieldObject('hyper_profile', {
  type: "String",
  description: undefined,
  nullable: true,
...
export const hyper_profileLast_synced_timeFieldObject = defineFieldObject('hyper_profile', {
...
export const hyper_profileDiabetes_statusFieldObject = defineFieldObject('hyper_profile', {
...
export const hyper_profileGlucose_range_typeFieldObject = defineFieldObject('hyper_profile', {
...
export const hyper_profileHyper_activityFieldObject = defineRelationFunction('hyper_profile', (t) =>
...
export const hyper_profileHyper_cgm_dataFieldObject = defineRelationFunction('hyper_profile', (t) =>
...
export const hyper_profileHyper_daily_recapFieldObject = defineRelationFunction('hyper_profile', (t) =>
...
export const hyper_profileHyper_mealFieldObject = defineRelationFunction('hyper_profile', (t) =>
...
export const hyper_profileUsersFieldObject = defineRelationObject('hyper_profile', 'users', {
  description: undefined,
  nullable: false,
  args: undefined,
  query: undefined,
...
export const hyper_profileHyper_reportFieldObject = defineRelationFunction('hyper_profile', (t) =>
