...
export const hyper_activity_typeObject = definePrismaObject('hyper_activity_type', {
  description: undefined,
  findUnique: ({ id }) => ({ id }),
  fields: (t) => ({
    id: t.field(hyper_activity_typeIdFieldObject),
    name: t.field(hyper_activity_typeNameFieldObject),
    hyper_activity: t.relation('hyper_activity', hyper_activity_typeHyper_activityFieldObject(t)),
  }),
});

export const hyper_activity_typeIdFieldObject = defineFieldObject('hyper_activity_type', {
  type: "ID",
  description: undefined,
  nullable: false,
...
export const hyper_activity_typeNameFieldObject = defineFieldObject('hyper_activity_type', {
  type: "String",
  description: undefined,
  nullable: false,
...
export const hyper_activity_typeHyper_activityFieldObject = defineRelationFunction('hyper_activity_type', (t) =>
