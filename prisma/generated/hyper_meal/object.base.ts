...
export const hyper_mealCarbohydratesFieldObject = defineFieldObject(
  "hyper_meal",
  {
    type: "Float",
    description: undefined,
...
export const hyper_mealDietary_energyFieldObject = defineFieldObject(
  "hyper_meal",
  {
    type: "Float",
    description: undefined,
...
export const hyper_mealDietary_sugarFieldObject = defineFieldObject(
  "hyper_meal",
  {
    type: "Float",
    description: undefined,
...
export const hyper_mealHyper_profileFieldObject = defineRelationObject(
  "hyper_meal",
  "hyper_profile",
  {
    description: undefined,
