...
export const upsertOnehyper_profileMutationObject = defineMutationFunction(
  (t) =>
    defineMutationPrismaObject({
      type: "hyper_profile",
      nullable: false,
      ...
      resolve: async (query, _root, args, _context, _info) =>
        await _context.prisma.hyper_profile.upsert({
          where: args.where,
          create: args.create,
          update: args.update,
          ...query,
...
export const upsertOnehyper_profileMutation = defineMutation((t) => ({
  upsertOnehyper_profile: t.prismaField(
    upsertOnehyper_profileMutationObject(t),
  ),
}));
