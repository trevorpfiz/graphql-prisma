...
export const hyper_reportContentFieldObject = defineFieldObject(
  "hyper_report",
  {
    type: "String",
    description: undefined,
...
export const hyper_reportProfile_idFieldObject = defineFieldObject(
  "hyper_report",
  {
    type: "String",
    description: undefined,
...
export const hyper_reportCreated_atFieldObject = defineFieldObject(
  "hyper_report",
  {
...
export const hyper_reportUpdatedAtFieldObject = defineFieldObject(
  "hyper_report",
  {
    type: Inputs.DateTime,
    description: undefined,
...
export const hyper_reportHyper_profileFieldObject = defineRelationObject(
  "hyper_report",
  "hyper_profile",
  {
    description: undefined,
