...
export const upsertOnehyper_activityMutationObject = defineMutationFunction(
  (t) =>
    defineMutationPrismaObject({
      type: "hyper_activity",
      nullable: false,
      ...
      resolve: async (query, _root, args, _context, _info) =>
        await _context.prisma.hyper_activity.upsert({
          where: args.where,
          create: args.create,
          update: args.update,
          ...query,
...
export const upsertOnehyper_activityMutation = defineMutation((t) => ({
  upsertOnehyper_activity: t.prismaField(
    upsertOnehyper_activityMutationObject(t),
  ),
}));
