...
export const upsertOnehyper_activity_typeMutationArgs = builder.args((t) => ({
  ...
  update: t.field({
    type: Inputs.hyper_activity_typeUpdateInput,
    required: true,
  }),
}));

export const upsertOnehyper_activity_typeMutationObject =
  defineMutationFunction((t) =>
    defineMutationPrismaObject({
      ...
      resolve: async (query, _root, args, _context, _info) =>
        await _context.prisma.hyper_activity_type.upsert({
          where: args.where,
          create: args.create,
          update: args.update,
          ...query,
...
export const upsertOnehyper_activity_typeMutation = defineMutation((t) => ({
  upsertOnehyper_activity_type: t.prismaField(
    upsertOnehyper_activity_typeMutationObject(t),
  ),
}));
