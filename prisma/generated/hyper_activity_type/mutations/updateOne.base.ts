...
export const updateOnehyper_activity_typeMutationObject =
  defineMutationFunction((t) =>
    defineMutationPrismaObject({
      ...
      resolve: async (query, _root, args, _context, _info) =>
        await _context.prisma.hyper_activity_type.update({
          where: args.where,
          data: args.data,
          ...query,
        }),
...
export const updateOnehyper_activity_typeMutation = defineMutation((t) => ({
  updateOnehyper_activity_type: t.prismaField(
    updateOnehyper_activity_typeMutationObject(t),
  ),
}));
