...
> = {
  ...
  hyper_activity_type: {
    ...
    mutations: {
      createMany:
        hyper_activity_type.createManyhyper_activity_typeMutationObject,
      createOne: hyper_activity_type.createOnehyper_activity_typeMutationObject,
      deleteMany:
        hyper_activity_type.deleteManyhyper_activity_typeMutationObject,
      deleteOne: hyper_activity_type.deleteOnehyper_activity_typeMutationObject,
      updateMany:
        hyper_activity_type.updateManyhyper_activity_typeMutationObject,
